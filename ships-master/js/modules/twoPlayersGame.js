        ...
        if(!this.myTurn) {
            ...
            if (value) {
                ...
                if (this.playerOneBoard.board[value.row][value.col].type === 'ship') {
                    ...
                    this.myTurn = true;
                    playerTwoBoardHTML.style.transform = "scale(1)";
                    playerOneBoardHTML.style.transform = "scale(0.8)";
        ...
        if(this.myTurn) {
            ...
            if (value) {
                ...
                if (this.playerTwoBoard.board[value.row][value.col].type === 'ship') {
                    ...
                    this.myTurn = false;
                    playerTwoBoardHTML.style.transform = "scale(0.8)";
                    playerOneBoardHTML.style.transform = "scale(1)";
